...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        function loaddata(page, cari, jml, tahun, kelas) {
            $.ajax({
                url: urlx + '/data',
                data: {
                    "page": page,
        ...
        function loadpage(cari, jml, tahun, kelas) {
            $.ajax({
                url: urlx + '/data',
                data: {
                    "cari": cari,
                ...
                success: function(response) {
                    ...
                    $pagination.twbsPagination($.extend({}, defaultOpts, {
                        ...
                        onPageClick: function(event, page) {
                            ...
                            loaddata(page, cari, jml, tahun, kelas);
                        }
        ...
        $("#pencarian, #jumlah, #school_year_filter, #classes_filter").on('change', function(event) {
            let cari = $('#pencarian').val();
            let jml = $('#jumlah').val();
            let tahun = $('#school_year_filter').val();
            let kelas = $('#classes_filter').val();
            loadpage(cari, jml, tahun, kelas);
        });
