...
use App\Repositories\Contracts\ClassesContract as ClassesRepo;
use App\Services\Contracts\ClassesContract;

class ClassesService implements ClassesContract
{
    protected $contractRepo;

    public function __construct(ClassesRepo $contractRepo)
    {
