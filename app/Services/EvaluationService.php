...
use App\Repositories\Contracts\EvaluationContract as EvaluationRepo;
use App\Services\Contracts\EvaluationContract;

class EvaluationService implements EvaluationContract
{
    protected $contractRepo;

    public function __construct(EvaluationRepo $contractRepo)
    {
