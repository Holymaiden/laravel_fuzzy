...
use App\Repositories\Contracts\ValueContract as ValueRepo;
use App\Services\Contracts\ValueContract;

class ValueService implements ValueContract
{
    protected $contractRepo;

    public function __construct(ValueRepo $contractRepo)
    {
